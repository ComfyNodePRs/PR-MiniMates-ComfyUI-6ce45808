...
def face_interface(tensor_source_img, tensor_source_prompt, tensor_drving_img,
    ...
    if FaceModel is None:
        ...
        # current_dir = os.path.dirname(os.path.abspath(__file__))
        inference_model_path = os.path.join(os.environ['minimates_models_dir'] , "FreeFace/epoch_40.pth")
...
def audio_interface(audio_path):
    ...
    if Audio2FeatureModel is None:
        # current_dir = os.path.dirname(os.path.abspath(__file__))
        ckpt_path = os.path.join(os.environ['minimates_models_dir'] , "lstm/lstm_model_epoch_590.pth")
    ...
    if PcaModel is None:
        ckpt_path = os.path.join(os.environ['minimates_models_dir'], "pca_mediapipe.pkl")
        import pickle
